...
class VideoIntelligenceServiceClient(object):
    ...
    def __init__(self,
        ...
        metrics_headers['gapic'] = pkg_resources.get_distribution(
            'gapic-google-cloud-videointelligence-v1beta1', ).version
    ...
    def annotate_video(self,
        ...
        Example:
          ...
          >>> from google.cloud.gapic.videointelligence.v1beta1 import enums
          >>> api = video_intelligence_service_client.VideoIntelligenceServiceClient()
          >>> input_uri = ''
          >>> features = []
          >>> response = api.annotate_video(input_uri, features)
          >>>
